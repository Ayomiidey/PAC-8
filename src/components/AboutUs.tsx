      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-blue-600 mb-4">Co-Founder & CEO</p>
        ...
        <div className="mt-24 text-center max-w-3xl mx-auto">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            ...
            dedication, and a deep understanding of our clients' needs. Our goal
            is to help businesses thrive in the digital age by providing
            cutting-edge solutions and outstanding service.
          </p>
        </div>
...
//             Turn ideas into reality, one package at a time.
//           </p>
//         </div>
